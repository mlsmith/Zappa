...
class TestZappa(unittest.TestCase):
    ...
    def test_create_lambda_package(self):
        # mock the pkg_resources.working_set to include a known package in lambda_packages so that the code
    ...
    def test_getting_installed_packages(self, *args):
        ...
        with mock.patch('os.path.isdir', return_value=True):
            with mock.patch('os.listdir', return_value=['super_package']):
                ...
                with mock.patch('pkg_resources.working_set', new_callable=mock.PropertyMock, side_effect=mock_pip_installed_packages):
